  ...
  return (
    <section ref={heroRef} className="relative h-screen min-h-[700px] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div
          ref={bgRef}
          className="absolute inset-[-5%] bg-cover bg-center parallax-bg transition-transform duration-100 ease-out"
          style={{
            backgroundImage: backgroundImage
              ? `url(${backgroundImage})`
              : `linear-gradient(135deg, #1A130C 0%, #3D2E1F 50%, #1A130C 100%)`,
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <span className="text-[20vw] font-display font-bold text-cream-50/[0.03] tracking-wider select-none">
            WBSK
          </span>
        </div>
      </div>
